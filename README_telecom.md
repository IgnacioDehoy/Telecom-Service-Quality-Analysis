...
```
├── telecomunicaciones_original.pbix                     ← Power BI dashboard
├── INFORME_FINAL_DEL_PROYECTO.pdf                       ← Full written report
├── DW_Telecomunicaciones_Modelo.pdf                     ← Data model diagram
├── informe_auditoria_calidad_datos.docx                 ← Data quality audit
└── README.md
```
...
- 💼 [LinkedIn](https://linkedin.com/in/ignacio-dehoy-munoz/)
- 📊 [Purpose Index Dashboard](https://github.com/IgnacioDehoy/-----purpose-index)
- 📊 [Tractor Market Analysis](https://github.com/IgnacioDehoy/Analysis-of-the-Tractor-Market-in-Lleida-2024-)
