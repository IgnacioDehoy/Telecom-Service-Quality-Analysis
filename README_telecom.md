...
| [Data Quality Audit](Telecom_DataQuality_Audit.pdf) | Data cleaning process, findings and validation results |
...
├── Telecom_DataQuality_Audit.pdf                 ← Data quality audit
└── README.md
```
